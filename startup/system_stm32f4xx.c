...
/** @addtogroup STM32F4xx_System_Private_Includes
  ...
  */
#include "stm32f4xx.h"
//RCC_ClocksTypeDef       SystemClockStatus;
...
#define 	PLL_M      8	// 1 MHz
#define 	PLL_N      336	// 336 MHz

/* SYSCLK = PLL_VCO / PLL_P */
#define 	PLL_P      2	// 168 MHz

/* USB OTG FS, SDIO and RNG Clock =  PLL_VCO / PLLQ */
#define 	PLL_Q      15	// 11.2 MHz
//
/******************************************************************************/
...
////////  //Configures the High Speed APB2 clock (PCLK2). Max=84 MHz
////////  RCC_PCLK2Config(RCC_HCLK_Div2);	//	84 MHz
////////  //Configures the Low Speed APB1 clock (PCLK1). Max=42 MHz
////////  RCC_PCLK1Config(RCC_HCLK_Div4);	//	42 MHz
...
////////    
////////    TimeOutCNT++;
////////    if(TimeOutCNT == 0xFFFFF00)
////////    {
////////      // switch to HSI frequency OR try again 
////////    }
////////  };
////////  
////////  //.........................................
...
////////  
////////  //Configures the system clock (SYSCLK).  /* Select the main PLL as system clock source */
////////  RCC_SYSCLKConfig(RCC_SYSCLKSource_PLLCLK); 	//  SYSCLK = 168 MHz
////////  
////////  /* Wait till the main PLL is used as system clock source */
////////  while ((RCC->CFGR & (uint32_t)RCC_CFGR_SWS ) != RCC_CFGR_SWS_PLL);
////////  {
////////    GPIO_WriteBit(GPIOD,GPIO_Pin_12,Bit_SET);		//@@@@ LED
////////  }
////////  
////////  GPIO_WriteBit(GPIOD,GPIO_Pin_13,Bit_SET);		//@@@@ LED
////////  
////////  //....................................  
////////  /*The system frequency computed by this function anb hold the frequencies into the "SystemClockStatus" Structure [ SYSCLK, HCLK, PCLK1 and PCLK2].*/
////////  RCC_GetClocksFreq(& SystemClockStatus);
